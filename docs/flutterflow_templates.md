...
- Undo/redo history is maintained by `RichNoteTextController` so toolbar復原/再製 can move backward and forward through rich editor changes.
...
- Home and notes FAB menus use enlarged bordered pills with staggered bottom-to-top slide/fade-in animation.
